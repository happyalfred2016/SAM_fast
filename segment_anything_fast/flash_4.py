...
assert not USE_CUSTOM_KERNEL


def _attention_rel_h_rel_w(q_, k_, v_, rel_h_, rel_w_, dropout_p):
    """
    ...
    return torch.nn.functional.scaled_dot_product_attention(q_, k_, v_, attn_mask=attn_bias, dropout_p=dropout_p)
